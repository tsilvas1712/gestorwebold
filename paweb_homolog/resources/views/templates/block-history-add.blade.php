        ...
        <script>
            $(function() {
                $('#history-add').on('submit', function(e) {
                    ...
                    showMessage(contracts[0].Cd_Credor);
                    /*if (contracts.length == 0){
                        $(".close").click();
                        showMessage("É preciso selecionar um contrato primeiro. 1111");
                        return false;
                        ...
                        $(".close").click();
                        showMessage("É preciso selecionar um contrato primeiro. 2222");
                        return false;
                    }

                    if ((contracts[0].Cd_Credor == '') || (contracts[0].Cd_Credor == '0')){
                        showMessage("É preciso selecionar um contrato primeiro. 333");
                        return false;
                    }
