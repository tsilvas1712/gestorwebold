    ...
    $.fn.jqGrid = function(a) {
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"], y = function(a, b) {
                    ...
                    $.isXMLDoc(a)) {
                        ...
                        O && Q) {
                            ...
                            for (d.p.grouping && (Y = d.p.groupingView.groupCollapse === !0,
                            W = $.jgrid.getMethod("groupingPrepare")); Q > R; ) {
                                t = O[R],
                                u = r(t, U + R),
                                u = d.p.idPrefix + u,
                                P = 0 === b ? 0 : b + 1,
                                ...
                                d.p.gridview === !1 && (V.append(L.join("")),
                        ...
                        S = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(L.join("")) : (V.append(L.join("")),
                    ...
                    if (a) {
                        ...
                        var Y, Z = $.isFunction(d.p.afterInsertRow), _ = [], aa = !1, ba = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"), ca = M ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", da = J ? k(l, "multiBox", !1, "cbox") : "";
                        for (d.p.grouping && (aa = d.p.groupingView.groupCollapse === !0,
                        Y = $.jgrid.getMethod("groupingPrepare")); t > o; ) {
                            ...
                            d.p.gridview === !1 && (ba.append(Q.join("")),
                        ...
                        _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (ba.append(Q.join("")),
                        d.grid.cols = d.rows[0].cells)),
                        d.p.subGrid === !0)
                            try {
                        ...
                        if (null != b.rules)
                            try {
                                ...
                                c = 0; c < b.rules.length; c++)
                                    ...
                                    q[h.op] && h.field && (k > 0 && g && "OR" === g && (r = r.or()),
                                    i = j[h.field],
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        if ($.each(d.p.colModel, function() {
                            ...
                            d.p.grouping)
                                for (n = 0,
                                m = p.groupField.length; m > n; n++)
                                    this.name === p.groupField[n] && (k[n] = j[o],
                                    l[n] = o);
                            d.p.multiSort || i || o !== d.p.sortname || (g = o,
                            i = !0)
                        }),
                        d.p.multiSort && (g = s,
                        h = t),
                        ...
                        if (d.p.ignoreCase && (r = r.ignoreCase()),
                        d.p.search === !0) {
                            var u = d.p.postData.filters;
                            if (u)
                                "string" == typeof u && (u = $.jgrid.parse(u)),
                                a(u);
                            else
                                try {
                    ...
                    f = a + "_center",
                    g = a + "_right",
                    $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"),
                    ...
                    if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                        ...
                        d.p.multiSort)
                            ...
                            var g, h = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null, i = d.p.frozenColumns ? f : d.grid.headers[b].el, j = "single" === d.p.viewsortcols[1];
                ...
                d.p.data.length && (I(),
                J());
                var ba, ca, da, ea, fa, ga, ha, ia, ja = "<thead><tr class='ui-jqgrid-labels' role='row'>", ka = "", la = "", ma = "";
                ...
                if ("horizontal" === d.p.viewsortcols[1] ? (la = " ui-i-asc",
                ma = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (la = " ui-single-sort-asc",
                ...
                $("th", sa).each(function(a) {
                    da = d.p.colModel[a].width,
                    void 0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0),
                    d.p.colModel[a].resizable ? (ea = document.createElement("span"),
                    $(ea).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"),
                    $(this).addClass(d.p.resizeclass)) : ea = "",
                    ...
                    "boolean" != typeof ka && (d.p.colModel[a].sortable = !0,
                    ka = !0);
                    var c = d.p.colModel[a].name;
                    "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"),
                    ka && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    if ("A" !== fa.tagName && ("INPUT" !== fa.tagName && "TEXTAREA" !== fa.tagName && "OPTION" !== fa.tagName && "SELECT" !== fa.tagName || b))
                        ...
                        fa.length > 0 && (za = $.jgrid.getCellIndex(fa),
                        ...
                        d.p.cellEdit !== !0) {
                            if (c)
                                if (d.p.multikey)
                                    a[d.p.multikey] ? $(d).jqGrid("setSelection", ya, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya).is(":checked"),
                                    $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                                    ...
                                    if (b)
                                        ...
                                        $(d.p.selarrrow).each(function(a, b) {
                                            ...
                                            f && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass(n),
                    ...
                    0 !== $(ga).length) {
                        ...
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(ga).attr("id"), ya, za, a),
                        null != b) ? b : void 0
                    }
                    ...
                    0 !== $(ga).length) {
                        ...
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(ga).attr("id"), ya, za, a),
                        null != b) ? b : void 0
                    }
                }),
                ...
                if ($(e.cDiv).append(Da).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)),
                ...
                d.p.toolbar[0]) {
                    ...
                    $(e.uDiv).addClass(Ea + " ui-userdata-top").attr("id", "t_" + this.id).insertBefore(e.hDiv).width(e.width),
                    $(e.ubDiv).addClass(Ea + " ui-userdata-bottom").attr("id", "tb_" + this.id).insertAfter(e.hDiv).width(e.width),
                    wa && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width).addClass(Ea + " ui-userdata-top").attr("id", "t_" + this.id),
                    wa && $(e.uDiv).hide()
                }
                ...
                d.p.caption) {
                    ...
                    d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                        ...
                        "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                            b--,
                            0 === b && ($("span", g).removeClass(Ba).addClass(Ca),
                            ...
                            b--,
                            0 === b && ($("span", g).removeClass(Ca).addClass(Ba),
                            wa && (d.p.datatype = Fa,
                            R(),
                            wa = !1),
    ...
    $.jgrid.extend({
        ...
        addRowData: function(a, b, c, d) {
            ...
            this.each(function() {
                ...
                o = w.p.altclass;
                var y, z = 0, A = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rowBox", !0, "jqgrow ui-row-" + w.p.direction), B = {}, C = !!$.isFunction(w.p.afterInsertRow);
                    ...
                    null !== c) {
                        ...
                        if (h !== d.p.savedRow[c].v) {
                            ...
                            if (t[0] === !0) {
                                ...
                                if ($.isFunction(d.p.beforeSubmitCell) && (v = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b),
                                v || (v = {})),
                                ...
                                "remote" === d.p.cellsubmit)
                                    if (d.p.cellurl) {
                                        ...
                                        j.editoptions && j.editoptions.NullIfEmpty && "" === g && (g = "null",
                                        u = !0),
                                        w[k] = g;
                                        var x, y, z;
                                        z = d.p.prmNames,
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter, h = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, j = function() {
                        ...
                        o = 0; o < s.sopt.length; o++)
                            ...
                            -1 !== i && (f = m === a.odata[i].oper ? h.highlight : "",
                    ...
                    a.restoreFromFilters && (f = c.p.postData.filters,
                    f && ("string" == typeof f && (f = $.jgrid.parse(f)),
                    e = f.rules.length ? f.rules : !1)),
                    $.each(c.p.colModel, function(b) {
                        ...
                        if (this.hidden === !0 && $(u).css("display", "none"),
    ...
    if ($.jgrid.extend({
        editGridRow: function(a, b) {
            ...
            this.each(function() {
                ...
                function d(a, b, c, d) {
                    var f, g, h, i, j, k, l, m = 0, n = [], o = !1, p = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", r = "";
                    for (l = 1; d >= l; l++)
                        r += p;
                    ...
                    $(b.p.colModel).each(function(l) {
                        ...
                        "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
                            ...
                            if ("_empty" === a && s.defaultValue && (i = $.isFunction(s.defaultValue) ? s.defaultValue.call(q) : s.defaultValue),
                    ...
                    m > 0) {
                        var s;
                        D ? (s = "<div class='FormData' style='display:none'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/>",
                        $(J).append(s)) : (s = $("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * d - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/></td></tr>"),
                        s[0].rp = m + 999,
                        $(c).append(s)),
                ...
                function g(a, b, c) {
                    var d, e, f, g, h, i, j = 0;
                    (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData = {},
                    ...
                    l && ($('td[role="gridcell"]', l).each(function(f) {
                        ...
                        "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                            ...
                            (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = e),
                            d = $.jgrid.jqID(d),
                            k[f].edittype) {
                            case "password":
                            case "text":
                            ...
                            case "select":
                                ...
                                (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).val(),
                                k[f].editoptions.multiple && (e = e.join(",")),
                                rp_ge[q.p.id]._savedData[d] = e);
                                break;
                            case "checkbox":
                                if (e = String(e),
                                ...
                                (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval"),
                                rp_ge[q.p.id]._savedData[d] = e);
                                break;
                            case "custom":
                                try {
                    ...
                    j > 0 && ($("#id_g", y).val(a),
                    (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[b.p.id + "_id"] = a)))
                }
                function h() {
                ...
                function i() {
                    var a, c, d, e, i, j, k, l = [!0, "", ""], m = {}, n = q.p.prmNames, o = $(q).triggerHandler("jqGridAddEditBeforeCheckValues", [$(w), u]);
                    o && "object" == typeof o && (s = o),
                    $.isFunction(rp_ge[q.p.id].beforeCheckValues) && (o = rp_ge[q.p.id].beforeCheckValues.call(q, s, $(w), u),
                    o && "object" == typeof o && (s = o));
                    for (e in s)
                    ...
                    l[0] && !rp_ge[q.p.id].processing) {
                        ...
                        var t = $.extend({
                            ...
                            complete: function(e, h) {
                                ...
                                rp_ge[q.p.id].closeAfterAdd ? (q.p.treeGrid !== !0 && $(q).jqGrid("setSelection", l[2]),
                                ...
                                }, 1e3)) : q.p.treeGrid === !0 ? $(q).jqGrid("setTreeRow", s[c], s) : $(q).jqGrid("setRowData", s[c], s),
                                ...
                                $.isFunction(rp_ge[q.p.id].afterComplete) && (a = e,
                                setTimeout(function() {
                                ...
                                "_empty" !== rp_ge[q.p.id]._savedData[q.p.id + "_id"]))
                ...
                if (q.grid && a) {
                    ...
                    A !== !1) {
                        ...
                        T = !0);
                        var U;
                        if (D ? ($(J).find("#pData").replaceWith(N),
                        $(J).find("#nData").replaceWith(O),
                        $(J).find("#sData").replaceWith(P),
                        $(J).find("#cData").replaceWith(Q),
                        U = $("<div id=" + x + "></div>").append(J)) : U = $("<div></div>").append(J).append(R),
                        ...
                        $("a.ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(z.themodal)).unbind("click").click(function() {
                        ...
                        b.saveicon[0] === !0 && $("#sData", r).addClass("right" === b.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.saveicon[2] + "'></span>"),
                        b.closeicon[0] === !0 && $("#cData", r).addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.closeicon[2] + "'></span>"),
                        ...
                        $("#sData", r).click(function() {
                            ...
                            $(".FormError", w).hide(),
                            c(),
                            "_empty" === s[q.p.id + "_id"] ? i() : b.checkOnSubmit === !0 ? (t = j(s, rp_ge[q.p.id]._savedData),
                            t ? ($(w).data("disabled", !0),
                        ...
                        $("#nData", r).click(function() {
                            ...
                            -1 !== a[0] && a[1][a[0] + 1]) {
                                ...
                                var c;
                                if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(q, "next", $(w), a[1][a[0]]),
                                void 0 !== c && c === !1))
                                    return !1;
                        ...
                        $("#pData", r).click(function() {
                            ...
                            if (-1 !== a[0] && a[1][a[0] - 1]) {
                                ...
                                var c;
                                if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(q, "prev", $(w), a[1][a[0]]),
                                void 0 !== c && c === !1))
                                    return !1;
                                if ($("#" + $.jgrid.jqID(a[1][a[0] - 1])).hasClass(f.disabled))
                                    return !1;
                            ...
                            e[0] && !rp_ge[c.p.id].processing) {
                                ...
                                var k = $.extend({
                                    ...
                                    complete: function(a, g) {
                                        ...
                                        $.isFunction(rp_ge[c.p.id].errorTextFormat) ? e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a) : e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)),
                                        e[0] === !1)
                ...
                if (!this.p.navGrid) {
                    ...
                    if (o.grid && "string" == typeof a) {
                        ...
                        p = 0; q > p; p++) {
                            ...
                            $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g)) : $(u + "_" + m.position, u).append(w).width(j),
    ...
    $.extend($.jgrid, {
            ...
            a) {
                ...
                if (b) {
                    ...
                    d && "object" === $.type(d)) {
                        ...
                        d.storeNavOptions && d.navGrid && (m[0].p.navGrid = !1,
                        m.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions),
        ...
        setRegional: function(a, b) {
            ...
            c.regional) {
                ...
                $.each(e, function(a) {
                    return this.formatter && "actions" === this.formatter ? (f = a,
                    !1) : void 0
                }),
    ...
    $.jgrid.extend({
        editRow: function(a, b, c, d, e, f, g, h, i) {
            ...
            this.each(function() {
                ...
                j.keys === !0 && $(e).bind(j.keyevent, function(b) {
                    if (27 === b.keyCode) {
                ...
                function n(a) {
                    ...
                    for (e in a)
                        if (a.hasOwnProperty(e)) {
                            ...
                            "level" === e && a.level > 0 && (a.level === (0 === s ? a.level : s) || -1 !== J[a.level].indexOf("_r_Totals"))) {
                                d = 0;
                                for (b in a.fields)
