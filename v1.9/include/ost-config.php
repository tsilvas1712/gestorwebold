...
define('SECRET_SALT','bU0KhnRm20NGmm1mT1VTUTsN51QQRLOo');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','jonas.schen@blcobranca.com.br');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','infradb.blcobranca.com.br');
define('DBNAME','desenvolvimento');
define('DBUSER','desenvolvimento');
define('DBPASS','@@dev5501');

# Table prefix
define('TABLE_PREFIX','chamados_');
