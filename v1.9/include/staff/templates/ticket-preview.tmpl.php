...
if($thisstaff->canTransferTickets())
    $options[]=array('action'=>'Transferir','url'=>"tickets.php?id=$tid#transfer");

$options[]=array('action'=>'Postar Nota','url'=>"tickets.php?id=$tid#note");

if($thisstaff->canEditTickets())
    $options[]=array('action'=>'Editar Ticket','url'=>"tickets.php?id=$tid&a=edit");
