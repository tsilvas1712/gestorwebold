...
if($stats['homolog']) {
    $nav->addSubMenu(array('desc'=>__('Em Homologa&ccedil;&atilde;o').' ('.number_format($stats['homolog']).')',
                           'title'=>__('Tickets em homologa&ccedil;&atilde;o'),
                           'href'=>'tickets.php?status=homolog',
                           'iconclass'=>'Ticket'),
                        ($_REQUEST['status']=='homolog'));
}

if($stats['block']) {
    $nav->addSubMenu(array('desc'=>__('Bloqueados').' ('.number_format($stats['block']).')',
                           'title'=>__('Tickets bloqueados'),
                           'href'=>'tickets.php?status=block',
