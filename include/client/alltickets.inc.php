...
$qselect='SELECT ticket.ticket_id,ticket.`number`,ticket.dept_id,isanswered, '
    ...
    .'dept.name as dept_name, status.name as status, status.state, ticket.source, ticket.created, cdata.dtConclusao ';
...
$qfrom.=' LEFT JOIN chamados_user user ON ticket.user_id=user.id ';

$qwhere = sprintf(' WHERE status.state="open" ');

$qwhere.= ' and user.org_id = (select org_id from chamados_user u where u.id = ' . $thisclient->getId(). ') ';
...
<table id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
    ...
    <thead>
        <tr>
            ...
            <th width="150">
                <a href="alltickets.php?sort=date&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="Ordenar por Data de Conclusão"><?php echo __('Previsão de Conclusão');?></a>
            </th>
...
//                $subject.='  &nbsp;&nbsp;<span class="Icon file"></span>';
            ...
            <tr id="<?php echo $row['ticket_id']; ?>">
                ...
                <td><?php echo $row['dtConclusao']; ?></td>
            </tr>
        <?php
        }
