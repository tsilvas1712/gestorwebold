        ...
        <div id="header">
            ...
            <p>
             <?php
                ...
                <a href="<?php echo ROOT_PATH; ?>tickets.php"><?php echo sprintf(__('Meus Tickets <b>(%d)</b>'), $thisclient->getNumTickets()); ?></a> |
                <a href="<?php echo ROOT_PATH; ?>alltickets.php">Ver Todos</a> |
                <a href="<?php echo $signout_url; ?>"><?php echo __('Sair'); ?></a>
            <?php
            } elseif($nav) {
